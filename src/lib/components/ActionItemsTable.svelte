    ...
    <TableBody>
      {#each visibleActionItems as actionItem, index}
        <TableBodyRow>
          ...
          <TableBodyCell class="px-2 py-4">
            <Button outline class="bg-customGray/10 text-customGray/50 hover:bg-customGray/30" on:click={() => editActionItem(index)}>
              <PenOutline />
            </Button>
          </TableBodyCell>
          <TableBodyCell class="px-2 py-4">
            <Button outline class="bg-customGray/10 text-customGray/50 hover:bg-customGray/30" on:click={() => removeActionItem(index)}>
              <Trash2 size={18} />
            </Button>
          </TableBodyCell>
        </TableBodyRow>
